...
class PerfilPolicy
{
    ...
    {
        return $usuario->possuiPermissao(Permissao::PerfilViewAny);
    }
    ...
    {
        return $usuario->possuiPermissao(Permissao::PerfilView);
    }
    ...
    {
        return $usuario->possuiPermissao(Permissao::PerfilUpdate);
    }
