 ...
 */
class PredioLivewireIndex extends Component
{
    ...
    public function getPrediosProperty()
    {
        return
        Predio::hierarquia()
            ->orWhereLike('predios.nome', $this->termo)
    ...
    {
        return view('livewire.arquivamento.cadastro.predio.index')->layout('layouts.app');
    }
