...
class PermissionLivewireUpdate extends Component
{
    ...
    {
        $this->authorize(Policy::ViewOrUpdate->value, Permission::class);
    }
    ...
    {
        return view('livewire.authorization.permission.edit')->layout('layouts.app');
    }
