...
<template>
    <Pagina :titulo="tituloPagina">
            ...
            <form @submit.prevent="atualizar">
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-x-3 gap-y-6 xl:grid-cols-2">
                        ...
                        <ChaveValor
                            :chave="__('Andar')"
                            :valor="sala.data.andar.apelido ?? sala.data.andar.numero"
                            icone="layers"
                        />
        ...
        <Container class="space-y-3">
            <div
                :class="{
                    'md:justify-between': sala.data.links.create_estante,
                    'md:justify-end': !sala.data.links.create_estante,
                }"
                class="flex flex-col space-y-3 md:flex-row md:items-start"
            >
                <InertiaButtonLink
                    v-if="sala.data.links.create_estante"
                    :href="sala.data.links.create_estante"
