...
<template>
    <Pagina :titulo="tituloPagina">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-x-3 gap-y-6 xl:grid-cols-2">
                        ...
                        <ChaveValor
                            :chave="__('Andar')"
                            :valor="
                                prateleira.data.estante.sala.andar.apelido ??
                                prateleira.data.estante.sala.andar.numero
                            "
                            icone="layers"
                        />
        ...
        <Container class="space-y-3">
            <div
                :class="{
                    'md:justify-between': prateleira.data.links.create_caixa,
                    'md:justify-end': !prateleira.data.links.create_caixa,
                }"
                class="flex flex-col space-y-3 md:flex-row md:items-start"
            >
                <InertiaButtonLink
                    v-if="prateleira.data.links.create_caixa"
                    :href="prateleira.data.links.create_caixa"
                    :texto="__('Nova caixa')"
                    icone="plus-circle"
                />
