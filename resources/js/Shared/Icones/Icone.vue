...
<template>
    ...
    <svg
        v-else-if="nome === 'arrow-clockwise'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'arrow-down-short'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'blockquote-left'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'box-arrow-in-right'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'brightness-high'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'emoji-sunglasses'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'file-earmark-text'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'hand-thumbs-down'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'journal-bookmark'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'person-lines-fill'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'question-circle'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'symmetry-vertical'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <svg
        v-else-if="nome === 'three-dots-vertical'"
        :class="class"
        fill="currentColor"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
