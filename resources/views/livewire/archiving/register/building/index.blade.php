...
<x-page :header="__('Buildings')">
    ...
    <x-container>
        ...
        <div class="flex items-center justify-between mb-3">
            ...
            @can(\App\Enums\Policy::Create->value, \App\Models\Building::class)

                <x-link-button
                    class="btn-do"
                    icon="plus-circle"
                    :href="route('archiving.register.building.create')"
                    :text="__('New')"
        ...
        <x-table wire:key="table-building" wire:loading.delay.class="opacity-25">
